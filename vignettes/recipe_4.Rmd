...
```{r setup}
library(tidyverse) # to manipulate and visualizae datasets
...
Let's read the curated dataset^[To inspect the process by which this dataset was created, you can look at [the source file](https://github.com/lin380/tadr/blob/master/vignettes/recipe_4.Rmd) for this recipe.]. (If you want to access this data you can use [the remote dataset URL]().)
